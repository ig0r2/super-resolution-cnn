...
from utils.path import get_data_path, get_project_root, get_checkpoints_path
...
if __name__ == "__main__":
    ...
    # HR_PATH = get_data_path('DIV2K/DIV2K_valid_HR/0873.png')

    # CROP_BOX = (421, 342, 64, 64)  # (x, y, w, h)
    # LR_PATH = get_project_root('inference/comparison/input/F1.png')
    # HR_PATH = get_project_root('inference/comparison/input/F1_gt.png')
    #
    # CROP_BOX = (407, 194, 64, 64)  # (x, y, w, h)
    # LR_PATH = get_project_root('inference/comparison/input/R6.png')
    # HR_PATH = get_project_root('inference/comparison/input/R6_gt.png')

    # CROP_BOX = (863, 319, 128, 128)  # (x, y, w, h)
    # LR_PATH = get_project_root('inference/comparison/input/wrc.jpg')
    # HR_PATH = get_project_root('inference/comparison/input/wrc_gt.jpg')
    #
    # CROP_BOX = (505, 365, 32, 32)  # (x, y, w, h)
    ...
    #
    # CROP_BOX = (505, 365, 32, 32)  # (x, y, w, h)
    # LR_PATH = get_project_root('inference/comparison/input/0879x2_85.jpg')
    # HR_PATH = get_data_path('DIV2K/DIV2K_valid_HR/0879.png')
    ...
    # LR_PATH = get_data_path('DIV2K/DIV2K_valid_LR_bicubic/X3/0879x3.png')
    # HR_PATH = get_data_path('DIV2K/DIV2K_valid_HR/0879.png')
