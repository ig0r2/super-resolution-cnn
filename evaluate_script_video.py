...
if __name__ == "__main__":
    ...
    CHECKPOINT_PATHS = [
        ...
        # Path("checkpoints/SR_RFDN_2x_1_4.pth"),
        ...
        # Path("checkpoints/SR_CustomERN_2x_b2_w0.75.pth"),
        # Path("checkpoints/SR_CustomERN_2x_b1_w1.pth"),
        # Path("checkpoints/SR_CustomERN_2x_b2_w1.pth"),
        # Path("checkpoints/SR_CustomERN_2x_b3_w1.pth"),
        # Path("checkpoints/SR_CustomERN_2x_b4_w1.pth"),
        # Path("checkpoints/SR_CustomERN_2x_b2_w2.pth"),
        # Path("checkpoints/SR_CustomERN_2x_b3_w2.pth"),
